...
export class SimilarityEngine {
  ...
  private getRelatedCategories(category: string): string[] {
    const categoryRelations: Record<string, string[]> = {
      'dbordo': ['fhmy', 'pirataria-thread', 'guides', 'tutorials'],
      'fhmy': ['dbordo', 'pirataria-thread', 'tools', 'resources'],
      'pirataria-thread': ['dbordo', 'fhmy', 'guides', 'tools'],
      'blog': ['news', 'updates'],
      'guides': ['dbordo', 'tutorials', 'fhmy'],
      'tools': ['utilities', 'fhmy', 'pirataria-thread'],
      'privacy': ['security', 'tools', 'fhmy'],
      'security': ['privacy', 'tools', 'fhmy'],
      'automation': ['dbordo', 'tools', 'pirataria-thread']
    }
