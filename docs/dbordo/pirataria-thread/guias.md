...
## 📑 ➜ [Aumente seu ratio com Autobrr](./autobrr.md)
...
## 📑 ➜ [Burlando o limite de download do mega](./burlando-limite-mega.md)
...
## 📑 ➜ [Download e Ativação do Windows e Office](./ativacao-office-win.md)
...
## 📑 ➜ [Como bloquear os anúncios na Twitch](./twitch.md)

Para uma experiência ainda melhor na Twitch. Tenha em mente que a qualidade da stream pode cair enquanto o ad passar.

## 📑 ➜ [Passos para instalar plugins de pesquisa no qBitTorrent](./guia-plugins-qbittorrrent.md)
...
## 📑 ➜ [Como configurar o DNS no Windows e Android](./dns.md)
...
## 📑 ➜ [Guia de como burlar restrição de download do Archive.org](./como-burlar-restrição-de-download-archive-org.md)
...
## 📑 ➜ [Verificando lançamentos de jogos usando PreDBs](./lancamentos-predbs.md)

Guia útil de como verificar lançamentos de jogos usando PreDB's com explicações úteis sobre a cena warez.

## 📑 ➜ [Guia de como converter Mangás para Kindle com Hakuneko e KCC](./guia-hakuneko.md)
...
## 📑 ➜ [Guia do Orchestralblend](./orchestralblend.md)

Alguns programas úteis. Tanto para Android quanto para Windows.

## 📑 ➜ [Guia de como usar o Stremio](./guia-stremio.md)
...
## 📑 ➜ [Guia de Privacidade para Paranoicos](./quero-privacidade.md)
